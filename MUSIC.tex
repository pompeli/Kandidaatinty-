...
% Miksi MUSIC-algoritmi?
%- Ei löydä maksimipisteitä samanaikaisesti
%- ei ongelmia minimien kanssa

% Ongelmia MUSICin kanssa
%- vaikeuksia erottaa oikea lähdepiikki väärästä
%- vaikeuksia korreloituneiden, lähellä toisiaan olevien lähteiden löytämisessä
%- useiden maksimien löytäminen vaikenee lähdeavaruuden kasvaessa
...
Kohinaa $\epsilon$ sanotaan valkoiseksi, jos se on muotoa $\epsilon = \sigma I$. Muussa tapauksessa kohina on värillistä.
